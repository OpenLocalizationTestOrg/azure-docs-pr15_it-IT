<properties
    pageTitle="Computer foglio irregolarità algoritmo di apprendimento | Microsoft Azure"
    description="Un computer stampabile foglio irregolarità algoritmo di apprendimento consente di scegliere algoritmo più adatto per il modello di previsione in Azure Machine formazione Studio."
    keywords="algoritmo irregolarità foglio, irregolarità, algoritmo di programmazione automatica"
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Foglio irregolarità algoritmo di apprendimento per Microsoft Azure Machine formazione Studio

**Microsoft Azure Machine Learning algoritmo irregolarità foglio** consente di scegliere l'algoritmo appropriato per un modello di previsione analitica.

[Azure Machine Learning Studio](https://studio.azureml.net/) dispone di una raccolta di grandi dimensioni degli algoritmi di ***regressione***, ***classificazione***, ***cluster***e le famiglie di ***rilevamento di anomalie in*** . Ciascuno è progettato per risolvere un particolare tipo di problema risorse computer.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Download: Apprendimento foglio irregolarità algoritmo

**Scaricare il foglio di irregolarità: [Risorse algoritmo irregolarità foglio macchina (11x17 pollici)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**

![Foglio di irregolarità macchina algoritmo di apprendimento: informazioni su come scegliere un algoritmo di apprendimento.][cheat-sheet]

[cheat-sheet]: ./media/machine-learning-algorithm-cheat-sheet/machine-learning-algorithm-cheat-sheet-small_v_0_6-01.png

Scaricare e stampare il computer risorse algoritmo irregolarità foglio dimensioni tabloid per mantenere comodo ed è possibile ottenere assistenza scelta di un algoritmo.

> [AZURE.NOTE] Vedere l'articolo [su come scegliere algoritmi per l'apprendimento di Microsoft Azure](machine-learning-algorithm-choice.md) per una Guida dettagliata all'uso di questo foglio irregolarità.

## <a name="more-help-with-algorithms"></a>Altre informazioni sulla algoritmi

* Per informazioni più approfondite dei diversi tipi di computer risorse algoritmi, modalità di utilizzo e come usare questo foglio irregolarità per scegliere l'algoritmo di destra, vedere [come scegliere algoritmi per l'apprendimento di Microsoft Azure computer](machine-learning-algorithm-choice.md).
