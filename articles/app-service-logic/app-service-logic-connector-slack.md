<properties 
    pageTitle="Usando il connettore margine di flessibilità nelle App logica | Servizio di Microsoft Azure App"
    description="Come creare e configurare l'app connettore margine di flessibilità o API e usarla in un'app di logica nel servizio App Azure"
    authors="msftman" 
    manager="erikre" 
    editor="" 
    services="logic-apps" 
...
# <a name="weve-improved-the-slack-connector"></a>Abbiamo modificato il connettore margine di flessibilità 
...
- [Ulteriori informazioni su questa nuovo connettore](../connectors/connectors-create-api-slack.md)
