<properties
    pageTitle="Usando il connettore di Dropbox nelle App logica | Servizio di Microsoft Azure App"
    description="Come creare e configurare l'app connettore Dropbox o API e usarla in un'app di logica nel servizio App Azure"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-dropbox-connector"></a>Abbiamo modificato il connettore Dropbox 
...
- [Ulteriori informazioni su questa nuovo connettore](../connectors/connectors-create-api-dropbox.md)
