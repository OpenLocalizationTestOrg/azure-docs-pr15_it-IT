<properties
   pageTitle="Utilizzo del connettore SMTP nelle App logica | Servizio di Microsoft Azure App"
   description="Come creare e configurare l'app connettore SMTP o API e usarla in un'app di logica nel servizio App Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-smtp-connector"></a>Abbiamo modificato il connettore SMTP 
...
- [Ulteriori informazioni su questa nuovo connettore](../connectors/connectors-create-api-smtp.md)
