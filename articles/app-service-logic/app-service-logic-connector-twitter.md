<properties
   pageTitle="Usando il connettore Twitter nelle App logica | Servizio di Microsoft Azure App"
   description="Come creare e configurare l'app connettore Twitter o API e usarla in un'app di logica nel servizio App Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-twitter-connector"></a>Abbiamo modificato il connettore Twitter 
...
- [Ulteriori informazioni su questa nuovo connettore](../connectors/connectors-create-api-twitter.md)
