...
| Consente di cercare e applicare gli aggiornamenti.                                                   |                                                                                                                                                               |
...
|                                        | Chiave di registrazione del servizio                          | Questo tasto viene generato dal portale di Azure.    |        |
...
|                                        | Interfaccia di rete: dati 2</br>Se abilitata iSCSI, non si configura il Gateway.      | Scopo: Cloud/iSCSI/non utilizzati</br>Indirizzo IP:</br>Maschera subnet:</br>Gateway:|
...
Eseguire questa procedura sull'host Windows Server.
